...
//   const [loading, setLoading] = useState(true);
  ...
  if (!expectedFriend) {
    return <SyncLoader color="#244D3F" className='text-center mt-30'/>
  }
    ...
    <div className="md:col-span-2 space-y-4 md:space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-white rounded-xl shadow p-4 text-center">
          ...
          <p className="text-xs sm:text-sm text-gray-500">Days Since Contact</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-4 text-center">
          ...
          <p className="text-xs sm:text-sm text-gray-500">Goal (Days)</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-4 text-center">
          ...
          <p className="text-xs sm:text-sm text-gray-500">Next Due</p>
        </div>
      </div>
      <div className="bg-white rounded-xl shadow p-4 sm:p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h3 className="font-medium text-lg sm:text-xl text-[#244D3F]">
            Relationship Goal
          </h3>
          <p className="text-gray-500 text-sm sm:text-lg">
            Connect every{" "}
            <span className="font-bold text-black">
              {expectedFriend.goal} Day
            </span>
          </p>
        </div>

        <button className="border px-3 py-1 rounded-lg text-sm hover:bg-gray-50">
          Edit
        </button>
      </div>
      <div className="bg-white rounded-xl shadow p-4 sm:p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          <button className="bg-[#F8FAFC] border-2 border-[#E9E9E9] rounded-xl py-5 flex flex-col items-center gap-2">
            <Phone /> Call
          </button>
